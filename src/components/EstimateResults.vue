  ...
  <div class="box">
      <div class="container">
        <div class="routing-header">
          <h3>Pricing search results from
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
         <div class="box-part text-center">
           ...
           <div class="">
               <img class="card-img-top-pickup" src="../assets/pickup-truck.png" alt="Card image cap">
           </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="box-next-part text-center">
              <button type="button" class="btn btn-primary btn-sm" name="button">
                <router-link id="backToEstimateBtn" :to="{ name: 'Estimate', params: {} }">Back to price estimate page</router-link>
              </button>
             </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="box-next-part text-center">
              <button type="button" class="btn btn-success btn-sm" name="button">
                <router-link id="proceedToRequestBtn" :to="{ name: '', params: {} }">Proceed to request delivery page</router-link>
              </button>
             </div>
          </div>
        </div>
