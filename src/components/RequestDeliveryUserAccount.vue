<template lang="html">
  <div class="container mb-2">
      <div class="row">
          ...
          <div class="col-md-3 sidebar-content">
                ...
                <div class="row image-row">
                  <b-img rounded="circle" class="image" thumbnail fluid :src="aviImage" alt="Image 1"></b-img>
                </div>
                ...
                <div class="row account-settings">
                    <ul>
                      <a href="#" @click.prevent="selectedPage = 'overview',
                      ...
                      <a href="#" @click.prevent="selectedPage = 'resetPassword',
                      ...
                      <a href="#" @click.prevent="selectedPage = 'accountSettings',
                      ...
                      <a href="#" @click.prevent="selectedPage = 'faq',
                                                  resetPasswordActive = '',
                                                  accSettingsActive='',
                                                  overviewActive='',
                                                  faqActive='active'">
                              ...
                              <form v-promise-btn="{action: 'submit'}" @submit.prevent="updateInfo">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control"
                                         id="fullName" aria-describedby="nameHelp"
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control"
                                         ...
                                         v-model="phoneNumber">
                                  <small id="emailHelp" class="form-text text-muted">Phone number cannot be altered.</small>
                                </div>
                                <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="form-group col-md-6 col-lg-6 col-sm-5 col-5">
                                      ...
                                      <input type="password"
                                             ...
                                             <span v-show="errors.first('newPassword')" class="help is-danger">* {{ errors.first('newPassword') }}</span>
                                    </div>
                                    <div class="form-group col-md-6 col-lg-6 col-sm-5 col-7">
                                      ...
                                      <input type="password"
                                             ...
                                             <span v-show="errors.first('confirmNewPassword')" class="help is-danger">*{{ errors.first('confirmNewPassword') }}</span>
                                    </div>
      ...
      <div>
        <b-modal no-close-on-backdrop hide-header-close no-close-on-esc ref="info-change-status-modal"
                 size="sm" id="info-change-status-modal" v-model="infoChangeStatusModal" title="Status">
  ...
  methods: {
    ...
    updateInfo(evt){
      ...
      if(this.emailAddress == user_data.emailAddress){
        this.info_change_status_message = 'Unable to update information. No change in data was detected';
        this.infoChangeStatusModal = true;
      }else{
        return this.$store.dispatch('changeEmail', payload)
                          .then((resp) => {
                            // update the email in the cookie storage too
                              user_data.emailAddress = this.emailAddress
                              this.$cookie.set(this.$cookeys.USER_DATA_KEY, JSON.stringify(user_data), {expires: this.$cookeys.cookie_expire})
                              // trigger modal
                          ...
                          .catch((error) => {
                            ...
                            if(error.response.status == 503){
                              this.info_change_status_message = 'Unable to update email. It looks like our servers are temporarily down. Please try again later'
                            }

                            else {
                               this.info_change_status_message = 'Unable to update email due to a technical glitch. Please try again later'
                            }
      ...
      return this.$validator.validateAll().then((result) => {
        if(result){
             ...
             if(this.currentPassword == this.newPassword){
               this.info_change_status_message = "Unable to change password. Please make sure new password is different from current password";
               this.infoChangeStatusModal = true;
             }else{
               return this.$store.dispatch('changePassword', payload)
                                 .then((resp) => {
                                 ...
                                 .catch((error) => {
                                   if(error.response.status == 503){
                                     this.info_change_status_message = 'Unable to update password. It looks like our servers are temporarily down. Please try again later'
                                   }
                                     ...
                                     this.info_change_status_message = 'Unable to update password due to a technical glitch. Please try again later'
                                   }
