<template lang="html">
  <div class="container mb-2">
    ...
    <div class="row" v-if="scheduledData.length > 0">
        <div class="col-md-10 col-lg-10 col-11 col-sm-11 scheduledContainer" v-for="(txns, index) in scheduledData" :key="index">
            <div class="row">
              <div class="col-md-9 col-sm-9 col-9 col-lg-9 scheduledContainerDetailText">
                  ...
                  <div class="">
                      <font-awesome-icon/> {{ txns.travellerPhone }}
                  </div>
                  <div class="">
                      <span class="alt-design">Pickup:</span>  {{ txns.pickup }}
                  </div>
                  <div class="">
                      <span class="alt-design">Update:</span> {{ txns.status }}
                  </div>
              </div>
              <div class="col-md-3 col-sm-3 col-3 col-lg-3 scheduledContainerDetailImage">
                <b-img-lazy :show="true" right :src="txns.travellerImage" class="travellerImage"
...
export default {
  ...
  mounted(){
    ...
    this.$store.dispatch('getScheduledTransactions', id)
               .then((resp) => {
