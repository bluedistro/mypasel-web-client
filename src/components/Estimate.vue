          ...
          <form @submit.prevent="getPricing">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="row">
                        <div class="col-lg-1 col-md-1 col-sm-12 p-0">
                          ...
                          <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                            <gmap-autocomplete @place_changed="getPickupAddressData"
                                               id="pickupMap" ref="pickupAddress"
                          ...
                          <div class="col-lg-2 col-md-3 col-sm-12 p-0">
                            <gmap-autocomplete @place_changed="getDropOffAddressData"
                                               id="dropOffMap" ref="dropOffAddress"
                                               class="form-control search-slt"
                                               :options="autoCompleteOptions"
                                               required
                      ...
                      <div class="col">
                          <span class="invalidLocationFeedback" v-if="invalidLocationAlert">Invalid location entry. Make sure a valid location is selected</span>
                      </div>
                  </div>
              </div>
          </form>
...
export default {
  ...
  methods: {
    ...
    getPricing(evt){
      ...
      const path = "https://api.desymal.com/v1/route/get?source=" + this.pickupData.location.lat() + ',' +
       this.pickupData.location.lng() + "&isSourceID=f&destination=" +  this.dropOffData.location.lat() + ',' +
        this.dropOffData.location.lng() + "&isDestID=f";
      axios.get(path)
      .then((res) => {
        ...
        localStorage.setItem(ROUTING_PATH_KEY, JSON.stringify({pickup_route: this.pickupData.formatted_address,
