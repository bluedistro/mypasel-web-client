        ...
        <div class="col-md-12 col-12  col-lg-12 col-sm-12" v-if="ongoingTransactions.length > 0">
              ...
              <div class="row item-container" v-for="(i, index) in ongoingTransactions" :key="index">
                <div class="col-md-10 col-sm-10 col-9 col-lg-10 transaction">
                    <progress-steps v-bind:step1="i.step0"
                                    v-bind:step2="i.step1"
                                    v-bind:step3="i.step2">
                    </progress-steps>
                    <div class="status">
                         {{ i.status }}
                    </div>
                ...
                <div class="col-md-2 col-sm-2 col-3 col-lg-2 moreBtn">
                  <button type="button" class="btn-sm btn-outline-dark form-control" @click="showMoreFunc(index)" name="button">More</button>
                </div>
                <div class="row courierFullDetailsDiv" v-if="showMore == index && showIndex">
                  <div class="courierTextDetailsDiv col-md-9 col-lg-9 col-9 col-sm-9" :id="index">
                          ...
                          <div class="details-text">
                            Transaction ID: {{i.transactionNumber}}
                          </div>
                          <div class="details-text">
                            Courier Name: {{ i.travellerName }}
                          </div>
                          <div class="details-text">
                            Contact: {{ i.travellerPhone }}
                          </div>
                          <div class="details-text">
                            Delivery Mode: {{ i.modeOfDelivery }}
                          </div>
                          <div class="details-text">
                            Delivery Update: {{ i.update }}
                          </div>
                          <div class="details-text">
                  ...
                  <div class="col-md-3 col-lg-3 col-3 col-sm-3 courierDetailsImage">
                      ...
                      <b-img-lazy :show="true" right :src="i.travellerImage" height="125px" width="125px" class="courierImage"
                                  rounded="circle" thumbnail fluid alt="Right image"></b-img-lazy>
                  </div>
                </div>
              </div>
        </div>
