...
import {
    faCog, faEdit, faCircle, faPlus, faArrowRight, faPencilAlt, faComment, faPhone, faAngleUp, faMoneyBillAlt, faFlag,
    faUserCircle, faTimes, faSignOutAlt, faUser, faArrowCircleRight, faSignInAlt, faUserPlus, faLock, faSearch, faMotorcycle,
    faBicycle, faCar, faTruckPickup, faWalking, faShuttleVan, faQuestionCircle, faComments, faHome, faMapPin, faAngleDown,
} from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon, FontAwesomeLayers, FontAwesomeLayersText } from '@fortawesome/vue-fontawesome';

library.add(
    faCog, faUserCircle, faSearch, faPhone, faAngleUp, faEdit, faCircle, faUser, faSignOutAlt, faQuestionCircle, faMoneyBillAlt,
    faPlus, faArrowRight, faArrowCircleRight, faPencilAlt, faComment,  faShuttleVan, faHome, faAngleDown, faFlag,
    faTimes, faMotorcycle, faBicycle, faWalking, faMapPin, faSignInAlt, faUserPlus, faLock, faCar, faTruckPickup,faComments,);
